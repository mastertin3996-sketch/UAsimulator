...
const STEPS = [
  ...
  {
    icon: "🧮",
    title: "Як порахувати прибутковість",
    text: "Перш ніж масштабуватись, порахуй: прибуток/тік = виторг − вартість сировини − зарплата/тік − оренда/тік − енергія/тік. Приклад із хлібом:",
    list: [
      { icon: <TrendingUp size={13} />, label: "Виторг", desc: "100 кг × ₴25 = ₴2 500/тік" },
      { icon: <Wheat size={13} />, label: "Сировина (борошно)", desc: "−₴1 500/тік" },
      { icon: <Building2 size={13} />, label: "Зарплата + оренда", desc: "−₴500/тік" },
      { icon: <ShoppingCart size={13} />, label: "Чистий прибуток", desc: "≈ ₴500/тік" },
    ],
    hint: "Собівартість дивись у вкладці «Фінанси» підприємства — якщо прибуток від'ємний, зміни рецепт, підвищи ціну або зменш витрати перед тим як розширюватись.",
  },
  {
    icon: "🛒",
