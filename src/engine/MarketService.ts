...
export class MarketService {
  ...
  private static readonly SEASONAL_NPC_DEMAND: Record<string, [number, number, number, number]> = {
    ...
    'FG-YOGURT':            [1.1, 1.2, 1.0, 0.9],  // літній пік — освіжаючий
    'FG-SOURCREAM':         [1.0, 0.9, 1.1, 1.2],  // зима — традиційна кухня
    'FG-COOKIES':           [1.0, 0.9, 1.1, 1.3],  // зимово-святковий
    'FG-DUMPLINGS':         [1.0, 0.7, 1.1, 1.5],  // зимовий пік — гаряча їжа
    'FG-MAYO':              [1.0, 1.1, 1.1, 1.3],  // салатний, пік на свята
    'FG-CANNED-MEAT':       [1.1, 1.0, 1.1, 1.2],  // стабільний, легкий зимовий пік
