...
async function main() {
  ...
  const productData = [
    ...
    { sku: 'EQ-SHELVING',    name:'Retail Shelving',         nameUa:'Торгові стелажі',            category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    { sku: 'EQ-DISPLAYFRIDGE',name:'Display Refrigerator',  nameUa:'Вітринний холодильник',      category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    { sku: 'EQ-FREEZER',     name:'Commercial Freezer',      nameUa:'Торговий морозильник',       category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    { sku: 'EQ-CCTV',        name:'CCTV System',             nameUa:'Система відеонагляду',       category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    { sku: 'EQ-SCALE',       name:'Retail Scale',            nameUa:'Торгові ваги',               category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    { sku: 'EQ-PRICETAG',    name:'Electronic Price Tags',   nameUa:'Система електронних цінників',category:'EQUIPMENT_ITEM',unit:'unit', isEquipmentItem: true },
    { sku: 'EQ-SELFCHECKOUT',name:'Self-Checkout Kiosk',     nameUa:'Каса самообслуговування',    category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    { sku: 'EQ-CONVEYOR',    name:'Conveyor Belt',           nameUa:'Конвеєрна стрічка',          category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    // Equipment items — office
    { sku: 'EQ-DESK',        name:'Office Desk',             nameUa:'Офісний стіл',               category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    { sku: 'EQ-OFFCHAIR',    name:'Office Chair',            nameUa:'Офісне крісло',              category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    { sku: 'EQ-COMPUTER',    name:'Computer Workstation',    nameUa:'Комп\'ютерне робоче місце',  category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    { sku: 'EQ-PRINTER',     name:'Office Printer',          nameUa:'Офісний принтер',            category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    { sku: 'EQ-PROJECTOR',   name:'Projector',               nameUa:'Проєктор',                   category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    { sku: 'EQ-SERVER',      name:'Server',                  nameUa:'Сервер',                     category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    { sku: 'EQ-PBXPHONE',    name:'PBX Phone System',        nameUa:'АТС та телефонія',           category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    { sku: 'EQ-AIRCON',      name:'Air Conditioner',         nameUa:'Кондиціонер',                category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    { sku: 'EQ-COFFEEMACH',  name:'Coffee Machine',          nameUa:'Кавова машина',              category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    { sku: 'EQ-OFFICESAFE',  name:'Office Safe',             nameUa:'Офісний сейф',               category:'EQUIPMENT_ITEM', unit:'unit', isEquipmentItem: true },
    // ── ПИВОВАРНЯ / АЛКОГОЛЬ ─────────────────────────────────────────────────
  ...
  const recipeSpecs = [
    ...
    },
    {
      ...
      inputs:  [],
      outputs: [{ sku: 'RM-SUGBEET',   qty: 5.0 }],
    },
    {
